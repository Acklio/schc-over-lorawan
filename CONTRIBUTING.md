...
documents](https://datatracker.ietf.org/wg/lpwan/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/lpwan/). If you're
...
sending an e-mail to the authors.
...
meaning of the specification), you can either:
  ...
  in the issue body. It is not necessary to notify the authors for editorial
  issues.
